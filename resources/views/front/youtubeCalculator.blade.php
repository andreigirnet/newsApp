    ...
    <div class="container">
        <div class="row flex justify-content-center">
            <div class="ytCalc ">
                ...
                <label for="shortViews" class="label-yt">Shorts Views Rate(0.04 cents/ 1000 views)</label>
                <input type="number" id="shortViews" class="input-yt" placeholder="Enter number of views" oninput="calculateRevenue()">

                <label for="longViews" class="label-yt">Long Videos Views Rate(1.5 dollar/ 1000 views)</label>
